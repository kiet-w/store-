      ...
      {reportLoading ? (
        ...
        <div className="flex flex-col gap-lg">
          ...
          <div className="card">
            ...
            {reportData.length === 0 ? (
              <div className="text-center p-lg text-secondary">Kho bãi được chọn chưa có hàng hóa hoặc giao dịch tồn kho nào.</div>
            ) : (
                  ...
                  <tbody>
                    {reportData.map((row) => (
                      <tr key={row.productId}>
                        ...
                        <td>
                          {row.discrepancy === 0 ? (
                            <span className="badge badge-completed" style={{ color: 'var(--status-success)', backgroundColor: 'rgba(34,197,94,0.1)' }}>Khớp</span>
                          ) : (
                            <span className="badge badge-failed" style={{ fontWeight: 'bold' }}>
