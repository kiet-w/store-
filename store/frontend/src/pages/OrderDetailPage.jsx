...
export default function OrderDetailPage() {
  ...
  // Fetch available shippers (only when modal is open or for admins/managers)
              ...
              <table className="data-table">
                <thead>
                  <tr>
                    <th>Mã SKU</th>
                    <th>Tên sản phẩm</th>
                    <th style={{ textRight: true }}>Số lượng</th>
                    <th style={{ textRight: true }}>Đơn giá</th>
                    <th style={{ textRight: true }}>Thành tiền</th>
                  </tr>
                </thead>
                <tbody>
